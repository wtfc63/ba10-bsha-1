...
import ch.zhaw.ba10_bsha_1.service.CharacterDetectionStrategyGraph;
import ch.zhaw.ba10_bsha_1.service.CharacterDetectionStrategyManager;
import ch.zhaw.ba10_bsha_1.service.CharacterDetectionStrategyNone;
import ch.zhaw.ba10_bsha_1.service.Edge;
import ch.zhaw.ba10_bsha_1.service.GraphMLExport;
import ch.zhaw.ba10_bsha_1.service.ICharacterDetectionStrategy;
import ch.zhaw.ba10_bsha_1.service.IMicroGestureDetectionStrategy;
import ch.zhaw.ba10_bsha_1.service.IPathSmoothingStrategy;
import ch.zhaw.ba10_bsha_1.service.IPreprocessingStrategy;
import ch.zhaw.ba10_bsha_1.service.MicroGesture;
import ch.zhaw.ba10_bsha_1.service.MicroGestureDetectionStrategyCurvature;
import ch.zhaw.ba10_bsha_1.service.MicroGestureDetectionStrategyNone;
import ch.zhaw.ba10_bsha_1.service.Node;
import ch.zhaw.ba10_bsha_1.service.PathSmoothingStrategySpline;
...
public class TouchInput {
	...
	private IPreprocessingStrategy smoothingStrategy;
	...
	public Collection<MicroGesture> detectMicroGestures(IMicroGestureDetectionStrategy strategy) {
		ArrayList<MicroGesture> tmp = new ArrayList<MicroGesture>(1);
		tmp.add(new MicroGesture(points));
		return (new ArrayList<MicroGesture>(strategy.detectMicroGestures(tmp)));
	}
	...
	public void startDetection() {
		...
		points = new ArrayList<TouchPoint>(smoothingStrategy.process(new MicroGesture(points)).getPoints());
	...
	public void addCharactersToGraph() {
		...
		//for (Character c : characters) {
			Node source = graph_strat.getRoot();
		...
		try {
			exp.writeFile(graph_strat.getRoot(), b);
		} catch (IOException e) {
