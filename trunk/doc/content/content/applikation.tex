...
Für unseren Backend-Dienst benötigen wir nun einen \emph{IntentFilter} der die \emp{Intents} für dessen Kommunikations-Schnittstellen annimmt und den \empp{Intent} definiert, unter dem der Dienst angesprochen werden kann.
